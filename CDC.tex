...
Lidée sera d'interpoler des données en tenant compte des erreurs de mesure, des points aberrants, et de trouver une ou plusieurs méthodes pour les détecter et les traiter suivant qu’elles soient uniformes ou non.
...
Pour commencer, on interpolera des points 1D en utilisant les splines naturelles C2 qui consistent à faire passer entre chaque point un polynôme de degré inférieur ou égal à 3 et qui soit de classe C2 dans le cas uniforme et non uniforme.
